...
public class PrivateBank implements Bank {
    ...
    /**
     * Deletes an account from the system, including its associated transactions
     * and the corresponding JSON file on the disk.
     *
     * @param account The name of the account to be deleted.
     * @throws AccountDoesNotExistException If the specified account does not exist in the system.
     * @throws IOException If there is an issue accessing the directory or deleting the account file.
     */
    @Override
    ...
    /**
     * Retrieves a list of all account names currently stored in the system.
     *
     * @return A list containing the names of all accounts.
     */
    @Override
